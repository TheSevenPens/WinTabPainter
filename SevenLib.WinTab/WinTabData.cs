...
public class WinTabData : IDisposable
{
    ...
    public bool SetPacketQueueSize(UInt32 NumPkts_I)
    {
        ...
        status = Interop.WinTabFunctions.WTQueueSizeSet(m_context.HCtx, NumPkts_I);
    ...
    public UInt32 GetPacketQueueSize()
    {
        ...
        numPkts = Interop.WinTabFunctions.WTQueueSizeGet(m_context.HCtx);
    ...
    public Structs.WintabPacketExt GetDataPacketExt(UInt32 hCtx_I, UInt32 pktId_I)
    {
        ...
        using (var buf = SevenLib.WinTab.Interop.UnmanagedBuffer.CreateForObject<Structs.WintabPacketExt>())
        {
            ...
            bool status = Interop.WinTabFunctions.WTPacket(hCtx_I, pktId_I, buf.Pointer);
    ...
    public void FlushDataPackets(uint NumPkts_I)
    {
        ...
        Interop.WinTabFunctions.WTPacketsGet(m_context.HCtx, NumPkts_I, IntPtr.Zero);
    }
    ...
    public Structs.WintabPacket[] GetDataPackets(UInt32 MaxPkts_I, bool remove, ref UInt32 NumPkts_I)
    {
        ...
        using (var buf = SevenLib.WinTab.Interop.UnmanagedBuffer.CreateForObjectArray<Structs.WintabPacket>((int)MaxPkts_I))
        {
            ...
            if (remove)
            {
                ...
                NumPkts_I = Interop.WinTabFunctions.WTPacketsGet(m_context.HCtx, MaxPkts_I, buf.Pointer);
            ...
            else
            {
                ...
                if (Interop.WinTabFunctions.WTQueuePacketsEx(m_context.HCtx, ref pktIDOldest, ref pktIDNewest))
                {
                    ...
                    UInt32 numFoundPkts = Interop.WinTabFunctions.WTDataPeek(m_context.HCtx, pktIDStart, pktIDEnd, MaxPkts_I, buf.Pointer, ref NumPkts_I);
