...
public class WinTabExtensions
{
    ...
    public static UInt32 GetWTExtensionMask(Enums.EWTXExtensionTag tag_I)
    {
        ...
        {
            extMask = Interop.WinTabFunctions.WTInfoAObject<UInt32>((uint)Enums.EWTICategoryIndex.WTI_EXTENSIONS + (uint)extIndex,
    ...
    public static UInt32 FindWTExtensionIndex(Enums.EWTXExtensionTag tag_I)
    {
        ...
        using (var buf = Interop.UnmanagedBuffer.CreateForObject<UInt32>())
        {
            ...
            {
                size = (int)Interop.WinTabFunctions.WTInfoA(
        ...
        )
    {
        ...
        using (var buf = SevenLib.WinTab.Interop.UnmanagedBuffer.CreateForObject<SevenLib.WinTab.Structs.WTExtensionProperty>())
        {
            buf.MarshalObjectlIntoBuffer(extProperty);

            bool status = Interop.WinTabFunctions.WTExtGet((UInt32)context_I, (UInt32)extTagIndex_I, buf.Pointer);
    ...
    )
    {
        ...
        using (var buf = SevenLib.WinTab.Interop.UnmanagedBuffer.CreateForObject<Structs.WTExtensionProperty>())
        {

            buf.MarshalObjectlIntoBuffer(extProperty.data);
            retStatus = Interop.WinTabFunctions.WTExtSet((UInt32)context_I, (UInt32)extTagIndex_I, buf.Pointer);
            return retStatus;
        }
    }
        ...
        )
    {
        ...
        using (var buf = SevenLib.WinTab.Interop.UnmanagedBuffer.CreateForObject<Structs.WTExtensionImageProperty>())
        {
